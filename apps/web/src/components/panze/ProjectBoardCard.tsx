...
export const ProjectBoardCard: React.FC<ProjectBoardCardProps> = ({ project, members, searchQuery, onProjectChange }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 shadow-card">
      ...
      <div className="mt-3 text-right text-sm text-slate-500">{filteredItems.length} task found · drag cards to move</div>

      <div className="mt-5 grid gap-4 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
            ...
            <div className="space-y-3">
              {grouped[status].map((item) => (
                <div
                  ...
                  className={`cursor-pointer rounded-3xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-accent-blue/50 hover:shadow-md ${
